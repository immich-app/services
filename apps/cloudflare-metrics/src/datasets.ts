...
// RUM Web Vitals has a 30-field-per-request Cloudflare cap, so we only select
// the total visit counters plus the average and p75/p95 quantile values.
// "good/needs-improvement/poor" buckets are omitted to stay under the limit;
// the averages and quantiles carry the same story more compactly.
export const RUM_WEB_VITALS: DatasetQuery = {
  ...
  topLevelFields: ['count'],
  blocks: {
    sum: ['visits', 'clsTotal', 'fcpTotal', 'fidTotal', 'inpTotal', 'lcpTotal', 'ttfbTotal'],
    avg: [
