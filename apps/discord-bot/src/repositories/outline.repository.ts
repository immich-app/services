...
import type { DocumentCreateResponse, IOutlineInterface } from '../interfaces/outline.interface.js';
...
export class OutlineRepository implements IOutlineInterface {
  async createDocument({
    ...
    const json = (await response.json()) as { data: DocumentCreateResponse };
    return json.data;
  }
