import type { GuildEmoji, MessageCreateOptions } from 'discord.js';
...
export interface IDiscordInterface {
  ...
  updateThread(
    location: { channelId: string; threadId: string },
    data: { name: string; message: string; appliedTags?: string[] },
  ): Promise<void>;
